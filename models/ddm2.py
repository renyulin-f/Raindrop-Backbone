...
from models.transformer2d2 import My_DiT_test
            ...
            for i, (x, y) in enumerate(train_loader):
                ...
                if self.args.test_set in ['RDiffusion', 'Raindrop_DiT']:
                    if self.step % self.config.training.snapshot_freq == 0 or self.step == 1:
                        checkpoint_path = os.path.join('Param_Mamba/'+ self.config.data.dataset +'/' + self.model_name + '_ddpm_epoch' + str(epoch)+'step' + str(self.step))
