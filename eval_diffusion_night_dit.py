...
def parse_args_and_config():
    ...
    parser.add_argument("--config", type=str, default='/data2/renyulin/RaindropClarity-main-1/configs/nighttime_64.yml',
                        help="Path to the config file")
    parser.add_argument('--resume', default='/data2/renyulin/RaindropClarity-main-1/Pretrained_Weights/Raindrop_DiT_ddpm_epoch3676step500000.pth.tar', type=str,
    ...
    parser.add_argument("--image_folder", default='results_50W/', type=str,
